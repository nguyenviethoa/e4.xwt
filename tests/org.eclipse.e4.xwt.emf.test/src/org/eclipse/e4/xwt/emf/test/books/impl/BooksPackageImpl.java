...
public class BooksPackageImpl extends EPackageImpl implements BooksPackage {
	 ...
	 * @see org.eclipse.e4.xwt.emf.test.books.BooksPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static BooksPackage init() {
		...
		BooksPackageImpl theBooksPackage = (BooksPackageImpl) (EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof BooksPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new BooksPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(bookstoreEClass, Bookstore.class, "Bookstore", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBookstore_Books(), this.getBook(), null, "books", null, 1, -1, Bookstore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBook_Price(), ecorePackage.getEDouble(), "price", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBook_Year(), ecorePackage.getELong(), "year", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBook_Title(), this.getTitle(), null, "title", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(titleEClass, Title.class, "Title", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTitle_Lan(), ecorePackage.getEString(), "lan", null, 0, 1, Title.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTitle_Text(), ecorePackage.getEString(), "text", null, 0, 1, Title.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
