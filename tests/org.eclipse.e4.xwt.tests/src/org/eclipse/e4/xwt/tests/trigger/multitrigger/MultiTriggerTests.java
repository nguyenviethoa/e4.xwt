...
public class MultiTriggerTests extends XWTTestCase {
	...
	public void test_Button_Click_MultiTrigger() {
		URL url = MultiTriggerTests.class.getResource(Button_Click_MultiTrigger.class
				.getSimpleName()
	...
	public void test_Button_Click_MultiTrigger_SourceName1() {
		URL url = MultiTriggerTests.class.getResource(Button_Click_MultiTrigger_SourceName.class
				.getSimpleName()
				+ IConstants.XWT_EXTENSION_SUFFIX);
		runTest(url, new Runnable() {
			public void run() {
