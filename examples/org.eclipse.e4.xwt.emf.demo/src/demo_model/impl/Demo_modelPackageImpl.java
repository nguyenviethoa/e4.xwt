 ...
 * @generated
 */
public class Demo_modelPackageImpl extends EPackageImpl implements Demo_modelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see demo_model.Demo_modelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Demo_modelPackageImpl() {
		super(eNS_URI, Demo_modelFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static Demo_modelPackage init() {
		if (isInited) return (Demo_modelPackage)EPackage.Registry.INSTANCE.getEPackage(Demo_modelPackage.eNS_URI);

		// Obtain or create and register package
		Demo_modelPackageImpl theDemo_modelPackage = (Demo_modelPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof Demo_modelPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new Demo_modelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theDemo_modelPackage.createPackageContents();

		// Initialize created meta-data
		theDemo_modelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theDemo_modelPackage.freeze();

		return theDemo_modelPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getEmployee_Birthday() {
	 ...
	 * @generated
	 */
	public Demo_modelFactory getDemo_modelFactory() {
		return (Demo_modelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(employeeEClass, EMPLOYEE__BIRTHDAY);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEmployee_Birthday(), ecorePackage.getEDate(), "birthday", null, 0, 1, Employee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getAddress_Zipcode(), ecorePackage.getEInt(), "zipcode", null, 0, 1, Address.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
