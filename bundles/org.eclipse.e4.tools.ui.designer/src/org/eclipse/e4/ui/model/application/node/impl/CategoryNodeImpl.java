 ...
 *******************************************************************************/
package org.eclipse.e4.ui.model.application.node.impl;
 ...
 * <ul>
 * <li>
 * {@link org.eclipse.e4.ui.model.application.node.impl.CategoryNodeImpl#getReference
 * <em>Reference</em>}</li>
 * <li>
 * {@link org.eclipse.e4.ui.model.application.node.impl.CategoryNodeImpl#getObject
 * <em>Object</em>}</li>
 * </ul>
 * </p>
 * 
...
public class CategoryNodeImpl extends EObjectImpl implements CategoryNode {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							NodePackage.CATEGORY_NODE__REFERENCE, oldReference,
							reference));
			}
		}
		return reference;
	...
	public EObject getObject() {
		if (object != null && object.eIsProxy()) {
			...
			if (object != oldObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							NodePackage.CATEGORY_NODE__OBJECT, oldObject,
							object));
			}
		}
		return object;
	...
	public void setObject(EObject newObject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NodePackage.CATEGORY_NODE__OBJECT, oldObject, object));
	}
