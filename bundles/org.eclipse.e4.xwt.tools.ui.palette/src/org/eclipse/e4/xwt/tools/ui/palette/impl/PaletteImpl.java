 ...
 * <ul>
 * <li>{@link org.eclipse.e4.xwt.tools.ui.palette.impl.PaletteImpl#getName <em>
 * Name</em>}</li>
 * <li>{@link org.eclipse.e4.xwt.tools.ui.palette.impl.PaletteImpl#getEntries
 * <em>Entries</em>}</li>
 * </ul>
 * </p>
 * 
...
public class PaletteImpl extends EObjectImpl implements Palette {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PalettePackage.PALETTE__NAME,
					oldName, name));
	}
	...
	public EList<Entry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<Entry>(Entry.class, this,
					PalettePackage.PALETTE__ENTRIES);
		}
		return entries;
	}
