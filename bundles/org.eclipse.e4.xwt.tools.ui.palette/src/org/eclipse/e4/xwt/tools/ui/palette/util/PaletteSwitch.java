...
public class PaletteSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PalettePackage.COMPOUND_INITIALIZER: {
			...
			if (result == null)
				result = caseInitializer(compoundInitializer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * <em>Palette</em>'. <!-- begin-user-doc --> This implementation returns
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Initializer</em>'. <!-- begin-user-doc --> This implementation
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Compound Initializer</em>'. <!-- begin-user-doc --> This
