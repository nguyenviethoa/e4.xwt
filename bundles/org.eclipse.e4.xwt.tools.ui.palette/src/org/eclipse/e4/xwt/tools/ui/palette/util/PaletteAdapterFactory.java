...
public class PaletteAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.e4.xwt.tools.ui.palette.Palette <em>Palette</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.e4.xwt.tools.ui.palette.CompoundInitializer <em>Compound Initializer</em>}'.
	 * <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
